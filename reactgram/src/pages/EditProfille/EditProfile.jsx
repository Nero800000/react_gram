...
const  EditProfile = () => {
  ...
  console.log("QURO VER O USER DO EDIT",user)
...
useEffect(()=> {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("UserDataaaaaaaaaaaaaa",userData)
  ...
  const handleFile = (e) => {
    ...
    return <div id="edit-profile">
       ...
       <form onSubmit={handleSubmit}>
        ...
        <input type="email" placeholder="E-mail" onChange={(e)=>setEmai(e.target.value)} value={email || ""} />
        ...
        <label>
            ...
            <input type="password" placeholder="Digite sua nova senha" onChange={(e)=>setPassword(e.target.value)} value={password || ""} />
                   ...
                   {!loading &&<button type="submit" >Conectar</button>}
